...
import {
  ...
  setTwitterContent,
} from "../controllers/twitter/twitter.controller.js";
import { runForAllUsers } from "../controllers/twitter/post.js";
const router = Router();
const fields = [
  {
    name: "video",
...
export const productRoutes = () => {
  ...
  router.get("/post_to_x", runForAllUsers);
  return router;
};
